 ...
 */
public class BackupConfigRecyclerView extends RecyclerView {
    ...
    public BackupConfigRecyclerView(Context context) {
        super(context);
    }

    public BackupConfigRecyclerView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public BackupConfigRecyclerView(Context context, AttributeSet attrs, int defStyle) {
